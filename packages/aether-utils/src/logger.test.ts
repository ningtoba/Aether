...
describe("Logger", () => {
  ...
  describe("JSON output", () => {
    ...
    it("should include source in JSON output", () => {
      logger = new Logger({ level: "info", source: "app", enableJson: true, enableTimestamp: false });
  ...
  describe("text format", () => {
    ...
    it("should include source in text format", () => {
      logger = new Logger({ level: "info", source: "myapp", enableTimestamp: false, enableJson: false });
