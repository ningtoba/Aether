...
export function registerIpcHandlers(): void {
  ...
  ipcMain.handle("agents:create", async (_event, data: { name: string; model?: string; description?: string; config?: Record<string, unknown> }) => {
  ...
  ipcMain.handle("providers:add", async (_event, data: { name: string; type: string; endpoint?: string; apiKey?: string; defaultModel?: string; models?: unknown[] }) => {
  ...
  ipcMain.handle("executions:start", async (_event, data: { agentId?: string; plan?: Record<string, unknown>; input?: unknown }) => {
  ...
  ipcMain.handle("plugins:install", async (_event, data: { name: string; version?: string; description?: string; author?: string; type?: string }) => {
